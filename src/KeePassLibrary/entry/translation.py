...
def get_library_translation(
    ...
    keepasslibrary = KeePassLibrary()
    translation = {}
    for function in keepasslibrary.attributes.values():
    ...
    translation["__init__"] = {
        "name": "__init__",
        "doc": inspect.getdoc(keepasslibrary),
        "sha256": hashlib.sha256(inspect.getdoc(keepasslibrary).encode("utf-16")).hexdigest(),  # type: ignore
    }
    translation["__intro__"] = {
        "name": "__intro__",
        "doc": keepasslibrary.__doc__,
        "sha256": hashlib.sha256(keepasslibrary.__doc__.encode("utf-16")).hexdigest(),  # type: ignore
    }
    return translation
